			...
			apply: function(dom, snapshot, options) {
				...
				if (bindings.selectOptions) {
					...
					if (value !== undefined) {
						...
						/* Preserve selected values, in case we don't also control the value of the select */
						var selectedValue = this.getValue(dom);
						...
						for (i = 0; i < value.length; i++) {
							...
							if (typeof value[i] === "object") {
								...
								newOption = new Option(value[i], value[i], false, false);
							}
							dom.options[i] = newOption;
						}

						/* Restore selected values. Supports multiple selection. */
						this.setValue(dom, selectedValue);
					}
				}
...
/*!
 * Consistent.js Expressions 0.14.1
 * @author Karl von Randow
 * @license Apache License, Version 2.0
 */
 /*
...
/*! 
 * Consistent.js jQuery plugin 0.14.1
 * @author Karl von Randow
 * @license Apache License, Version 2.0
 */
 /*
